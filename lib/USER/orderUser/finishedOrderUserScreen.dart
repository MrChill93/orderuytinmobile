...
class finishedOrderUserScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _finishedOrderUserScreenState();
  }
}

class _finishedOrderUserScreenState extends State<finishedOrderUserScreen> {
  @override
    ...
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, state) {
        if (state is AuthenticatedState) {
          ...
          Scaffold(
        body: FutureBuilder(
      future: fetchDataFinishedOrder(http.Client(),state.user.userName ?? ""),
