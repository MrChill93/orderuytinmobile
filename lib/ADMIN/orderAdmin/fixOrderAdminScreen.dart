...
class fixOrderAdminScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _fixOrderAdminScreenState();
  }
}

class _fixOrderAdminScreenState extends State<fixOrderAdminScreen> {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Scaffold(
        body: FutureBuilder(
      future: fetchDataFixOrder(http.Client()),
