...
class finishedOrderAdminScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _finishedOrderAdminScreenState();
  }
}

class _finishedOrderAdminScreenState extends State<finishedOrderAdminScreen> {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Scaffold(
        body: FutureBuilder(
      future: fetchDataFinishedOrder(http.Client()),
