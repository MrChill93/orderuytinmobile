...
class boughtOrderAdminScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _boughtOrderAdminScreenState();
}

class _boughtOrderAdminScreenState extends State<boughtOrderAdminScreen> {
  @override
