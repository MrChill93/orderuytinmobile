...
class deleveriedOrderAdminScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _deleveriedOrderAdminScreenState();
}

class _deleveriedOrderAdminScreenState
    extends State<deleveriedOrderAdminScreen> {
  @override
